...
```
       MPos    WPos       ← col-label: 10px, --ts, 右揃え
X   119.581  119.581      ← axis: font-mono 11px --ts / val: font-mono 18px --tp 右揃え
Y    76.025   76.025
Z     1.038    1.038
```

- グリッド: `grid-template-columns: 14px calc((100% - 12px) / 2 - 14px) 1fr`・gap 4px
- 値フォント: `font-mono`・**18px**・`--tp`・右揃え・`letter-spacing: -0.01em`
- 軸ラベル: `font-mono`・11px・`--ts`
- 列ラベル: 10px・`--ts`・右揃え
